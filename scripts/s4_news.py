...
const NEWS_STORAGE_KEY = "eray_mansur_news_v2";
const NEWS_COMMENTS_KEY = "eray_mansur_news_comments_v2";
...
const DEFAULT_NEWS: NewsArticle[] = [
  ...
  {
    id: "news_2",
    title: "YENİ KLİP: 'NAFİLE' YAYINDA — YOUTUBE TRENDLERDE 1 NUMARAYA YERLEŞTİ!",
    excerpt: "Frankfurt sokaklarında çekilen 'NAFİLE' resmi klibi 48 saatte milyonlarca izlenmeye ulaştı.",
    content: "ERAY067'nin sert flowları ve MANSUR'un akılda kalıcı nakaratıyla şekillenen NAFİLE klibi dijital platformlarda fırtına gibi esiyor. Avrupa sokak estetiğini ve yüksek tempolu kurgusunu izlemek için resmi video sekmemizi ziyaret edin.",
  ...
  },
  {
    ...
    excerpt: "Mansur'un prodüktörlüğünde Frankfurt ve İstanbul stüdyolarında 12 yeni parça hazırlanıyor.",
...
export const NewsService = {
  ...
  getAllNews(): NewsArticle[] {
    ...
    try {
      ...
      return data.length > 0 ? data : DEFAULT_NEWS;
    } catch {
      return DEFAULT_NEWS;
    }
  },
...
with open("src/services/newsService.ts", "w", encoding="utf-8") as f:
    f.write(code)
print("newsService.ts written successfully")
