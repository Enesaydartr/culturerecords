with open("scripts/create_components.py", "w", encoding="utf-8") as f:
    f.write('''import os

part1 = """import React, { useState, useEffect, useRef } from "react";
...
export default function RightSidebarDrawer({
  ...
  const [activeTab, setActiveTab] = useState<"playlists" | "mixes" | "chat" | "sync">("playlists");
